...
cleos push action rideor initialize '["sarabrown", "seller", "rider","50.0000 SYS", "20.0000 SYS","order 2",0]' -p sarabrown

cleos push action rideor initialize '["tester", "seller", "rider","50.0000 SYS", "20.0000 SYS","order 3",0]' -p tester
