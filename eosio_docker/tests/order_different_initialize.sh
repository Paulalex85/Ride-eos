...
cleos push action rideor needdeliver '["tester", "seller", "50.0000 SYS", "20.0000 SYS","order 1"]' -p tester
...
cleos push action rideor initialize '["tester", "seller", "rider","50.0000 SYS", "20.0000 SYS","order 4"]' -p tester
...
cleos push action rideor initialize '["tester", "seller", "rider","50.0000 SYS", "20.0000 SYS","order 5"]' -p tester
